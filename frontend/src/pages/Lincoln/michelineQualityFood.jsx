...
import diningHallImg from '../../images/Lincoln/Michelin/diningHall.jpg'
import foodImg from '../../images/Lincoln/Michelin/introduction1.jpg'
import salmonImg from '../../images/Lincoln/Michelin/Salmon.jpg';
import steakImg from '../../images/Lincoln/Michelin/Steak.webp';
import wagyuImg from '../../images/Lincoln/Michelin/Wagyu.webp';
import dessertImg from '../../images/Lincoln/Michelin/Dessert.webp';
        ...
        <div className="flex flex-col lg:flex-row gap-20 relative mb-48">
          ...
          <div className="lg:w-7/12 relative group p-1">
            ...
            <div className="relative overflow-hidden group border border-white/5">
              <img src={diningHallImg} className="w-full h-80 md:h-[750px] object-cover filter brightness-[0.85] contrast-[1.1] group-hover:brightness-100 group-hover:scale-105 transition-all duration-[2000ms] ease-out" alt="Dining Experience" />
        ...
        <div className="mt-32 md:mt-64 flex justify-center w-full mb-32">
          <div className="relative w-full max-w-5xl bg-[#1e221a] p-8 md:p-16 lg:p-24 shadow-2xl overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <img src={foodImg} alt="Breakfast" className="w-24 h-24 rounded-full object-cover mb-12 border border-amber-500/30 transition-all duration-1000 shadow-[0_0_30px_rgba(217,119,6,0.1)]" />
        ...
        <div className="mt-32 md:mt-48 relative pb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 relative z-10 w-full mx-auto">
            ...
            <div className="md:col-span-8 relative group overflow-hidden h-80 md:h-[650px] bg-[#1a1d17] cursor-pointer">
              <img src={salmonImg} alt="Atlantic Harvest" className="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-[3000ms] brightness-[0.85] group-hover:brightness-100 ease-out" />
            ...
            <div className="md:col-span-4 relative group overflow-hidden h-80 md:h-[650px] bg-[#1a1d17] cursor-pointer">
              <img src={steakImg} alt="Estate Garden" className="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-[3000ms] brightness-[0.85] group-hover:brightness-100 ease-out" />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-700"></div>
              <div className="absolute bottom-0 left-0 p-8 md:p-12 translate-y-8 group-hover:translate-y-0 transition-transform duration-700 ease-out">
            ...
            <div className="md:col-span-4 relative group overflow-hidden h-80 md:h-[500px] bg-[#1a1d17] cursor-pointer md:mt-8 z-20 shadow-2xl">
              <img src={wagyuImg} alt="Signature wagyu" className="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-[3000ms] brightness-[0.85] group-hover:brightness-100 ease-out" />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-80 group-hover:opacity-100 transition-opacity duration-700"></div>
            ...
            <div className="md:col-span-8 relative group overflow-hidden h-64 md:h-[500px] bg-[#1a1d17] cursor-pointer md:mt-8">
              <img src={dessertImg} alt="Sweet Finale" className="w-full h-full object-cover group-hover:scale-[1.03] transition-transform duration-[3000ms] brightness-[0.85] group-hover:brightness-100 ease-out" />
